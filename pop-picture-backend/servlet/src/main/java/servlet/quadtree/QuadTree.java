...
public class QuadTree {
    ...
    public void load(List<UserPicture> userPictures) {
        for(UserPicture userPicture : userPictures)
            addNeighbour(userPicture.getId(), userPicture.getLatitude(), userPicture.getLongitude());
    }

    public void addNeighbour(long id, double latitude, double longitude) {
