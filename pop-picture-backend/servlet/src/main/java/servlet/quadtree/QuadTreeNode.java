...
public class QuadTreeNode {
     ...
     * ---------
     */
    private QuadTreeNode mTopLeftNode;
     ...
     * ---------
     */
    private QuadTreeNode mTopRightNode;
     ...
     * ---------
     */
    private QuadTreeNode mBottomLeftNode;
     ...
     * ---------
     */
    private QuadTreeNode mBottomRightNode;

    /**
     *  List of points of interest A.K.A neighbours inside this node
     *  this list is only filled on the deepest nodes
     */
     ...
     */
    private QuadTreeNode locateAndCreateNodeForPoint(double latitude, double longitude) {
